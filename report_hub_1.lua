...
local totalHeight = numPlayers * 30 + (numPlayers - 1) * 3 + 5 -- 30 is button height, 3 is padding, 5 is extra margin
DropdownFrame.CanvasSize = UDim2.new(0, 0, 0, math.max(150, totalHeight))
end
